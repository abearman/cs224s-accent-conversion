function [x, aspc, spec] = invmelfcc(cep, sr, numcep, nbands, wintime, hoptime, varargin)
...
[lifterexp, sumpower, preemph, dither, ...
 minfreq, maxfreq, bwidth, dcttype, fbtype, usecmp, modelorder, broaden, excitation] = ...
    process_options(varargin, ...
          'lifterexp', -22, 'sumpower', 1, 'preemph', 0.97, ...
	  'dither', 0, 'minfreq', 0, 'maxfreq', 8000, ...
	  'bwidth', 1.0, 'dcttype', 2, ...
	  'fbtype', 'mel', 'usecmp', 0, 'modelorder', 0, 'broaden', ...
                    0, 'excitation', []);

% lifterexp was 0.6, nbands was 40, maxfreq was 4000
% wintime was 0.025 (25 ms), hoptime was 0.010 (10 ms)
